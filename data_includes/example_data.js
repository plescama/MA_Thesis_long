       ...
       .settings.center()
        ...
        .print()
               ...
               newText("information", "<p>Bevor Du das Experiment startest, lies bitte die folgenden Dokumente"
                       +" <a href='https://amor.cms.hu-berlin.de/~plescaan/Master/probanden_info_ONLINE.pdf' target='_blank' >Probanden-Informationsblatt</a> and"
                       +" <a href='https://amor.cms.hu-berlin.de/~plescaan/Master/einverstaendnis_ONLINE.pdf' target='_blank'>Einwilligungserkl&auml;rung</a>.<p>")    
               .settings.css("font-size", "20px")
               ,
...
PennController("instructions",
        ...
        ,
         ...
         newText("instructions_a", "<b>Deine Aufgaben w&auml;hrend des Experiments:</b><p>"
                        + "In diesem Experiment wirst Du S&auml;tze &uuml;ber Menschen, Handlungen und Berufe lesen, sowie Bilder ausw&auml;hlen. Dabei wird die Verarbeitung von Sprache im Kontext untersucht."
               ...
               // .remove(getText("bio_example4"))
                ...
                .settings.center()
                ,
                newText("example",  "<p><i>'___ ____ _____ _____ _______ __ ___ _____'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example1",  "<p><i>'Ich ____ _____ _____ _______ __ ___ _____'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example2", "<p><i>'Ich esse _____ _____ _______ __ ___ _____'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example3", "<p><i>'Ich esse jetzt _______ _______ __ ___ _____'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example4", "<p><i>'Ich esse jetzt meinen _______ __ ___ _____</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example5", "<p><i>'Ich esse jetzt meinen Joghurt __ ___ _____'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example6", "<p><i>'Ich esse jetzt meinen Joghurt in ___ _____.'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example7", "<p><i>'Ich esse jetzt meinen Joghurt in der _____.'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ,
                newText("example8", "<p><i>'Ich esse jetzt meinen Joghurt in der K&uuml;che.'</i>")
                .settings.css("font-size", "15px")
                .settings.css("font-family","courier")
                ...
                .settings.add(70,440, getText("example6"))
                .print()  
                ,    
                newKey("ex6"," ")
                .wait()
                ...
                .settings.add(70,440, getText("example7"))
                .print()
                ,
                newKey("ex7", " ")
                .wait()
                ,
                getCanvas("instruccanvas")
                .remove(getText("example7"))
                .settings.add(70,440, getText("example8"))
                .print()
                ,
                newKey("instr_c", " ")
                .wait()
...
PennController.Template( PennController.GetTable("master_spr1.csv")
